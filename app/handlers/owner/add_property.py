...
from app.utils.states import AddProperty
from app.services.user_service import get_user
from app.services.property_service import add_property
from app.services.media_service import add_photos_to_property, add_video_note_to_property

# --- ИСПРАВЛЕНИЕ ЗДЕСЬ: Указываем единственно верный файл с клавиатурами ---
from app.keyboards.inline_keyboards import (get_region_keyboard, get_district_keyboard, get_rooms_keyboard, 
